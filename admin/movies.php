...
if(isset($_POST['submit']))
{
    ...
    $sql="insert into tbl_movies(name,lan_id,image) value('$name','$lan_id','$image')";
...
<section id="main-content">
 ...
 if(isset($_FILES['image']))
 {
	 ...
	 {
         if(move_uploaded_file($file_tmp,'movies/'.$file_name))
		 { 
...
<tbody>
  ...
  while($row=mysqli_fetch_array($result))
  {
    ...
    <td><a href="editmovies.php?id=<?php echo $row['id']?>">
